...
function HorizontalInfoCard({ info, index, onEdit, onDelete, onView }) {
    ...
    return (
        <div className={`min-w-[300px] w-[340px] h-[180px] ${theme.bg} rounded-[2rem] p-6 flex flex-col justify-between relative group transition-all hover:-translate-y-1 shadow-sm snap-center`}>
